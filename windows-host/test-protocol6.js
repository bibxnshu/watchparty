...
app.whenReady().then(() => {
  ...
  win.loadURL('data:text/html,<video id="v" src="watchparty://local/C:/Users/biban/Downloads/your_movie_watchparty.mp4" autoplay controls></video><script>v.onloadedmetadata = () => console.log("META LOADED: " + v.duration)</script>');
